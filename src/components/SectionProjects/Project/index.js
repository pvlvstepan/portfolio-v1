...
const Project = ({ data }) => {
    ...
    return (
        <VStack maxW={{ xs: 'full', lg: '650', xl: '670' }} align='left' spacing='20px'>
            ...
            <Box as={motion.div} ref={textRef}
                variants={slideFade}
                initial='hidden'
                animate={textAnimation} rounded='2xl' bg={bg} p={6} boxShadow='md'>
            ...
            <SimpleGrid as={motion.div} ref={buttonRef}
                variants={slideFade}
                initial='hidden'
                animate={buttonAnimation} columns={2} row={1} maxW={{ xs: 'full', sm: '300px' }} gridGap={6}>
