...
const projectsData = [
    ...
    },
    {
        ...
        liveView: "http://codd-damage-detector-test.herokuapp.com/",
    },
    {
        title: "MSU-NTI BigData",
        img: bigdata,
        description:
    ...
    },
    {
        ...
        description: (
            <>
                MovieLister is a single page application that I've developed
                during a coding interview at{" "}
                <ParagraphLink
                    text="BigData MSU"
                    to="https://bigdata.msu.ru/"
                />
                . The app features movies that are being pulled from{" "}
                <ParagraphLink text="YTS.mx" to="https://yts.mx/api" /> API and
                displays them in a neatly designed pages on the website.
            </>
        ),
    ...
    },
    {
        ...
        liveView: "http://msu-coral-research.herokuapp.com/",
        simple: true,
    },
];
